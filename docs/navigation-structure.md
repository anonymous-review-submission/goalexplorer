...
To add a auxiliary navigation item to your site (in the upper right on all pages), add it to the `aux_nav` [Instruction]({{ site.baseurl }}{% link docs/instruction.md %}#aux-nav) in your site's `_config.yml` file.
